...
class Boid2: GameObject {
    ...
    func align(boids: [Boid2]) -> SIMD3<Float> {
    ...
    func cohesion(boids: [Boid2]) -> SIMD3<Float> {
        var steeringForce = SIMD3<Float>(repeating: 0)
        var totalConsideredBoids: Float = 0
    ...
    func separation(boids: [Boid2]) -> SIMD3<Float> {
        var steeringForce = SIMD3<Float>(repeating: 0)
        var totalConsideredBoids: Float = 0
